      ...
      <section className="section-padding pt-32 md:pt-40">
        <div className="container-narrow">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {plans.map((p) => {
              const price =
                p.name === "Custom"
                  ? null
                  : pricing[currency][p.name as "Starter" | "Growth"];
          ...
          <p className="text-center mt-10 text-muted-foreground text-xs">
            All plans require a 12-month commitment. Hosting, domain
            registration, and ongoing maintenance are included at no extra cost.
          </p>
        </div>
      </section>
      <CTABlock />
